...
function Projects() {
  return (
    <div id="projects" className=' text-white mx-4 mb-16 md:m-28 h-auto  scroll-mt-16 md:scroll-mt-32'>
      ...
      <div id='castit' className='bg-[#2d2d2d] rounded-xl p-6 align-middle'>
        <h1 className='text-xl mb-2 font-sfpro'>CastIt</h1>
        <div className='md:inline-flex md:max-h-screen'>
          <div>
            <p className='text-md lg:leading-10 py-auto font-sfprolight tracking-wide text-lg mb-2'>CastIt is a web app that allows users to create and share ranked-voting elections. It can be used to simplify group decisions and offers a more equitable alternative to usual voting methods.</p>
            <h1 className='mx-auto underline text-md font-sfpro underline-offset-2'>Stack</h1>
            <p className='text-[#319fff] mb-4'>React, NodeJS, Express, Redux Toolkit, MongoDB </p>
          </div>
          <Image src={castitPic} alt='CastIt' className='rounded-xl h-auto w-auto'/>
        </div>
      </div>

      <div id='Botbias' className='bg-[#2d2d2d] rounded-xl p-6 align-middle mt-6'>
        ...
        <div className='md:inline-flex md:max-h-screen'>
          <div>
            ...
            <h1 className='mx-auto underline text-md font-sfpro underline-offset-2'>Stack</h1>
            <p className='text-[#319fff] mb-4'>Python (data cleansing), Django, HuggingFace API, Twitter API, </p>
          </div>
          <Image src={BotBiasPic} alt='botbias' className='rounded-xl'/>
        </div>
      </div>

      <div id='Transparency' className='bg-[#2d2d2d] rounded-xl p-6 align-middle mt-6'>
        ...
        <div className='md:inline-flex md:max-h-screen'>
          <div>
            ...
            <h1 className='mx-auto underline text-md font-sfpro underline-offset-2'>Stack</h1>
            <p className='text-[#319fff] mb-4'>React, Express, Python (data scraping and cleansing), Oracle DB, AWS</p>
          </div>
          <Image src={TransparencyPic} alt='Transparency' className='rounded-xl'/>
        </div>
      </div>

      <div id='PennOS' className='bg-[#2d2d2d] rounded-xl p-6 align-middle mt-6'>
