...
const NavBar = () => {
    return (
        <nav className="navbar hidden md:flex align-middle justify-between space-x-10 p-4 text-white font-sfpro">
            <h1 className="my-auto ml-3 py-2 text-[#e2e2e2] text-3xl">
                    luis
